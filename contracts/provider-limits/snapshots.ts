...
export const snapshot_status_schema = z.enum(["fresh", "stale", "partial", "error"]);
...
export type ProviderLimitSnapshot = z.infer<typeof provider_limit_snapshot_schema>;

export const provider_limits_response_schema = z.object({
  providers: z.array(provider_limit_snapshot_schema),
});
export type ProviderLimitsResponse = z.infer<typeof provider_limits_response_schema>;
