...
export const qmd_log_entry_schema = z.object({
	id: z.string(),
	session_id: z.string(),
...
export type QmdLogEntry = z.infer<typeof qmd_log_entry_schema>;

export const qmd_log_stats_schema = z.object({
...
export type QmdLogStats = z.infer<typeof qmd_log_stats_schema>;
