			...
			<DialogContent className="sm:max-w-md" showCloseButton={false}>
				...
				<div className="space-y-4">
					...
					<div className="space-y-1.5">
						<label
							className="text-sm font-medium text-foreground"
							htmlFor="add-collection-path"
						>
							Path to docs
						</label>
						<div className="flex gap-2">
							<Input
								id="add-collection-path"
								className="flex-1"
					...
					<div className="space-y-1.5">
						<label
							...
							htmlFor="add-collection-pattern"
						>
							Glob Pattern
							<InfoTip
								title="Glob Pattern"
							...
							>
								<div className="space-y-1.5">
									<p>
										A pattern that determines which files to include from the
										selected folder.
									</p>
