					...
					<div className="flex items-center gap-2">
						...
						<InfoTip title="Collection Contexts" side="right" align="start">
							<div className="space-y-1.5">
								<p>
									Contexts are descriptions attached to{" "}
									<strong>path prefixes</strong> within this collection. They
									tell QMD what different sections of your documents are about.
								</p>
								...
								<ul className="space-y-0.5 ml-1">
									<li>
										...
										→ <em>"REST API reference documentation"</em>
									</li>
									<li>
										<code className="bg-muted px-1 rounded text-[11px]">
											guides/
										</code>{" "}
										→ <em>"Step-by-step tutorials for beginners"</em>
									</li>
								</ul>
								<p>
									This metadata improves search relevance by giving QMD extra
									understanding of your file structure.
								</p>
							</div>
						</InfoTip>
					</div>
			...
			<CardContent className="space-y-2">
				{contexts.length === 0 && !draft && (
					<p className="text-sm text-muted-foreground">
						No contexts defined for this collection.
					</p>
				)}
				{contexts.map((ctx) => (
