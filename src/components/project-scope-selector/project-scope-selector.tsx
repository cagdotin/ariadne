...
function is_all_projects_option(
	...
	return (
		option !== null && "id" in option && option.id === all_projects_value.id
	);
}

function is_project_option(
	option: ProjectScopeOption | null,
): option is ProjectSummary {
	return option !== null && !is_all_projects_option(option);
}

function is_same_option(
	a: ProjectScopeOption | null,
	b: ProjectScopeOption | null,
) {
