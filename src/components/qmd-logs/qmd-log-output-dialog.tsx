...
export function QmdLogOutputDialog({ entry, on_close }: QmdLogOutputDialogProps) {
  ...
  return (
    <Dialog open onOpenChange={(open) => { if (!open) on_close(); }}>
      <DialogContent className="sm:max-w-3xl max-h-[86vh] flex flex-col overflow-hidden p-0" showCloseButton={false}>
        {/* Header */}
        ...
        {/* Metadata */}
        <DialogDescription render={<div />} className="px-4 py-3 border-b border-t space-y-2 shrink-0 bg-muted/20">
