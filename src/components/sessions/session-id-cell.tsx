	...
	return (
		...
		>
			<div className="flex items-center gap-2 min-w-0 w-full">
				<Tooltip>
					<TooltipTrigger className="shrink-0 rounded bg-muted px-1.5 py-0.5 font-mono text-[11px] leading-none text-muted-foreground group-hover:bg-primary/10 group-hover:text-primary transition-colors">
						{short_id}
					</TooltipTrigger>
