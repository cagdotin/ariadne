...
export const SpanRow = memo(function SpanRow({ row, total_duration_ms, is_selected, on_select, on_toggle, view_start_ms, view_end_ms }: SpanRowProps) {
  ...
  return (
    ...
    >
      {/* Tree cell */}
      <div className="flex-none overflow-hidden border-r border-border" style={{ width: "var(--tree-width)" }}>
        <SpanTreeCell row={row} is_selected={is_selected} on_toggle={on_toggle} />
      </div>
