// Ported from agents/extensions/qmd/ui/toggle-state.ts
import { collect_file_paths, type FileTreeNode } from "./qmd-tree";
...
export class ToggleState {
	...
	toggle_dir(node: FileTreeNode): void {
		...
		const any_included = descendant_paths.some((p) =>
			this.is_effectively_indexed(p),
		);
