...
describe("qmd", () => {
	test("qmd_list_indexes", async () => {
		...
		const golden = normalize_qmd_indexes(
			read_golden("qmd/list-indexes.json"),
			qmd_cache_root,
		);
	...
	test("qmd_get_status — default", async () => {
		...
		const golden = normalize_qmd(
			read_golden("qmd/default-status.json"),
			qmd_cache_root,
		);
		expect(actual).toEqual(golden);
	});
	...
	test("qmd_list_collections — default", async () => {
		...
		const actual = normalize_qmd(actual_raw, qmd_cache_root);
		const golden = normalize_qmd(
			read_golden("qmd/default-collections.json"),
			qmd_cache_root,
		);
		expect(actual).toEqual(golden);
	});
	...
	test("qmd_get_collection_detail — default/docs", async () => {
		...
		const actual = normalize_qmd(actual_raw, qmd_cache_root);
		const golden = normalize_qmd(
			read_golden("qmd/default-collection-detail.json"),
			qmd_cache_root,
		);
		expect(actual).toEqual(golden);
	});
	...
	test("qmd_get_status — work", async () => {
		...
		const actual = normalize_qmd(actual_raw, qmd_cache_root);
		const golden = normalize_qmd(
			read_golden("qmd/work-status.json"),
			qmd_cache_root,
		);
		expect(actual).toEqual(golden);
	});
	...
	test("qmd_check_availability", async () => {
		...
		const actual = normalize_qmd(actual_raw, qmd_cache_root);
		const golden = normalize_qmd(
			read_golden("qmd/availability.json"),
			qmd_cache_root,
		);
		expect(actual).toEqual(golden);
	});
