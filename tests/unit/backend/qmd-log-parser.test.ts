...
describe("parse_qmd_logs_from_session", () => {
  ...
  it("returns empty when no QMD commands found", () => {
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
    ...
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      { type: "session", id: "s1", cwd: "/proj" },
      {
        ...
        message: {
          role: "assistant",
          content: [
            { type: "toolCall", id: "tc1", name: "bash", arguments: { command: "qmd search 'test'" } },
          ],
        },
      },
      {
    ...
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      { type: "session", id: "s1", cwd: "/proj" },
      {
        ...
        message: {
          role: "assistant",
          content: [
            { type: "toolCall", id: "tc1", name: "bash", arguments: { command: "qmd status" } },
          ],
        },
      },
      {
    ...
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      { type: "session", id: "s1", cwd: "/proj" },
      {
        ...
        message: {
          role: "assistant",
          content: [
            { type: "toolCall", id: "tc1", name: "bash", arguments: { command: "qmd embed" } },
          ],
        },
      },
    ...
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      { type: "session", id: "s1", cwd: "/proj" },
      {
        ...
        message: {
          role: "assistant",
          content: [
            { type: "toolCall", id: "tc1", name: "bash", arguments: { command: "qmd search 'foo'" } },
            { type: "toolCall", id: "tc2", name: "bash", arguments: { command: "qmd status" } },
          ],
        },
      },
      { type: "message", message: { role: "toolResult", toolCallId: "tc1", content: "r1" } },
      { type: "message", message: { role: "toolResult", toolCallId: "tc2", content: "r2" } },
    ));
    ...
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      { type: "session", id: "s1", cwd: "/proj" },
      {
        ...
        message: {
          role: "assistant",
          content: [
            { type: "toolCall", id: "tc-abc", name: "bash", arguments: { command: "qmd ls" } },
          ],
        },
      },
      { type: "message", message: { role: "toolResult", toolCallId: "tc-abc", content: "" } },
    ));
      ...
      { type: "session", id: "s1", cwd: "/proj" },
      {
        ...
        message: {
          ...
          content: [
            ...
            { type: "toolCall", id: "tc2", name: "bash", arguments: { command: "qmd search 'test'" } },
          ],
        },
      },
      { type: "message", message: { role: "toolResult", toolCallId: "tc2", content: "found" } },
    ));
  ...
  it("handles Bash (capitalized) tool name", () => {
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      ...
      { type: "message", message: { role: "toolResult", toolCallId: "tc1", content: "ok" } },
    ));
  ...
  it("truncates long output previews to 200 chars", () => {
    ...
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      ...
      { type: "message", message: { role: "toolResult", toolCallId: "tc1", content: long_output } },
    ));
  ...
  it("detects JSON search output kind", () => {
    ...
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      ...
      { type: "message", message: { role: "toolResult", toolCallId: "tc1", content: search_json } },
    ));
    ...
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      { type: "session", id: "s1", cwd: "/proj" },
      {
        ...
        message: {
          role: "assistant",
          content: [
            { type: "toolCall", id: "tc1", name: "bash", arguments: { command: "qmd paths" } },
          ],
        },
      },
      { type: "message", message: { role: "toolResult", toolCallId: "tc1", content: files_json } },
    ));
  ...
  it("detects raw text output kind", () => {
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      ...
      { type: "message", message: { role: "toolResult", toolCallId: "tc1", content: "QMD is running v2.0" } },
    ));
    ...
    vi.mocked(fs.readFileSync).mockReturnValue(make_jsonl(
      { type: "session", id: "sess-123", cwd: "/Users/me/my-project" },
      {
        ...
        message: {
          role: "assistant",
          content: [
            { type: "toolCall", id: "tc1", name: "bash", arguments: { command: "qmd ls" } },
          ],
        },
      },
      { type: "message", message: { role: "toolResult", toolCallId: "tc1", content: "" } },
    ));
