...
describe("format_tool_call_label", () => {
  ...
  it("formats read with file_path", () => {
    expect(format_tool_call_label("read", { file_path: "/Users/me/src/app.ts" }))
      .toBe("[read: ~/src/app.ts]");
  });

  it("formats read with path (legacy arg name)", () => {
    expect(format_tool_call_label("read", { path: "/Users/me/src/app.ts" }))
      .toBe("[read: ~/src/app.ts]");
  });
  ...
  it("formats write with file_path", () => {
    expect(format_tool_call_label("write", { file_path: "/Users/me/src/app.ts" }))
  ...
  it("formats edit with file_path", () => {
    expect(format_tool_call_label("edit", { file_path: "/home/user/src/app.ts" }))
  ...
  it("formats bash with short command", () => {
    expect(format_tool_call_label("bash", { command: "ls -la" }))
      .toBe("[bash: ls -la]");
  });
  ...
  it("formats grep with pattern and path", () => {
    expect(format_tool_call_label("grep", { pattern: "TODO", path: "/Users/me/src" }))
      .toBe("[grep: /TODO/ in ~/src]");
  });

  it("formats grep with default path", () => {
    expect(format_tool_call_label("grep", { pattern: "TODO" }))
      .toBe("[grep: /TODO/ in .]");
  });
  ...
  it("formats find with pattern and path", () => {
    expect(format_tool_call_label("find", { pattern: "*.ts", path: "/Users/me/src" }))
      .toBe("[find: *.ts in ~/src]");
  });
  ...
  it("formats ls with path", () => {
    expect(format_tool_call_label("ls", { path: "/Users/me/src" }))
      .toBe("[ls: ~/src]");
  });
