...
import {
	...
	shorten_path,
} from "@/components/session-viewer/utils/path";

// ── shorten_path ────────────────────────────────────────────────────────

describe("shorten_path", () => {
	it("replaces /Users/<name> prefix with ~", () => {
		expect(shorten_path("/Users/john/projects/app/src/file.ts")).toBe(
			"~/projects/app/src/file.ts",
		);
	});

	it("replaces /home/<name> prefix with ~", () => {
		expect(shorten_path("/home/john/projects/app/src/file.ts")).toBe(
			"~/projects/app/src/file.ts",
		);
	});
	...
	it("handles path with spaces", () => {
		expect(shorten_path("/Users/john/My Documents/file.ts")).toBe(
			"~/My Documents/file.ts",
		);
	});
...
describe("get_language_from_path", () => {
	...
	it("handles deep paths", () => {
		expect(get_language_from_path("/src/components/ui/button.tsx")).toBe(
			"typescript",
		);
	});
});
