...
describe("strip_project_prefix", () => {
	...
	it("strips an exact project path prefix", () => {
		expect(
			strip_project_prefix("/Users/me/project/src/app.ts", "/Users/me/project"),
		).toBe("src/app.ts");
	});
	...
	it("strips leading slash when raw path equals project path (no file part)", () => {
		...
		expect(strip_project_prefix("/Users/me/project", "/Users/me/project")).toBe(
			"Users/me/project",
		);
	});
	...
	it("handles raw path with no slashes", () => {
		expect(strip_project_prefix("file.ts", "/some/project")).toBe("file.ts");
	});

	it("does not strip when project path is unrelated", () => {
		expect(
			strip_project_prefix("/other/path/file.ts", "/Users/me/project"),
