...
describe("handelize_path", () => {
  ...
  it("replaces special characters in file name but preserves extension", () => {
    expect(handelize_path("My Component.test.tsx")).toBe("my-component-test.tsx");
  });
  ...
  it("handles deeply nested paths", () => {
    expect(handelize_path("src/components/ui/Button.tsx"))
...
describe("count_files", () => {
  it("counts zero for a leaf file", () => {
    const file: FileTreeNode = {
      ...
      children: [], file_count: 0, indexed: false, dir_index_status: "none",
    };
  ...
  it("counts files in a directory recursively", () => {
    const dir: FileTreeNode = {
      ...
      children: [
        { name: "a.ts", path: "src/a.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
        {
          name: "sub", path: "src/sub", is_dir: true,
          children: [
            { name: "b.ts", path: "src/sub/b.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
          ],
          file_count: 0, indexed: false, dir_index_status: "none",
        },
      ],
      file_count: 0, indexed: false, dir_index_status: "none",
    };
...
describe("compute_dir_index_status", () => {
  it("returns 'all' when all files are indexed", () => {
    const dir: FileTreeNode = {
      name: "src", path: "src", is_dir: true,
      children: [
        { name: "a.ts", path: "a.ts", is_dir: false, children: [], file_count: 0, indexed: true, dir_index_status: "none" },
        { name: "b.ts", path: "b.ts", is_dir: false, children: [], file_count: 0, indexed: true, dir_index_status: "none" },
      ],
      file_count: 0, indexed: false, dir_index_status: "none",
    };
  ...
  it("returns 'some' when partially indexed", () => {
    const dir: FileTreeNode = {
      ...
      children: [
        { name: "a.ts", path: "a.ts", is_dir: false, children: [], file_count: 0, indexed: true, dir_index_status: "none" },
        { name: "b.ts", path: "b.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
      ],
      file_count: 0, indexed: false, dir_index_status: "none",
    };
  ...
  it("returns 'none' when no files are indexed", () => {
    const dir: FileTreeNode = {
      name: "src", path: "src", is_dir: true,
      children: [
        { name: "a.ts", path: "a.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
      ],
      file_count: 0, indexed: false, dir_index_status: "none",
    };
  ...
  it("returns 'none' for empty directory", () => {
    const dir: FileTreeNode = {
      name: "empty", path: "empty", is_dir: true,
      children: [],
      file_count: 0, indexed: false, dir_index_status: "none",
    };
...
describe("sort_tree", () => {
  it("places directories before files", () => {
    const root: FileTreeNode = {
      name: "root", path: "root", is_dir: true,
      children: [
        { name: "z.ts", path: "z.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
        { name: "a", path: "a", is_dir: true, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
      ],
      file_count: 0, indexed: false, dir_index_status: "none",
    };
  ...
  it("sorts alphabetically within same type", () => {
    const root: FileTreeNode = {
      name: "root", path: "root", is_dir: true,
      children: [
        { name: "c.ts", path: "c.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
        { name: "a.ts", path: "a.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
        { name: "b.ts", path: "b.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
      ],
      file_count: 0, indexed: false, dir_index_status: "none",
      ...
      children: [
        {
          ...
          children: [
            {
              name: "b", path: "a/b", is_dir: true,
              children: [
                { name: "file.ts", path: "a/b/file.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
              ],
              file_count: 1, indexed: false, dir_index_status: "none",
            },
          ],
          file_count: 1, indexed: false, dir_index_status: "none",
        },
      ...
      children: [
        {
          name: "a", path: "a", is_dir: true,
          children: [
            { name: "x.ts", path: "a/x.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
            { name: "y.ts", path: "a/y.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
          ],
          file_count: 2, indexed: false, dir_index_status: "none",
        },
      ],
      file_count: 2, indexed: false, dir_index_status: "none",
    };
      ...
      children: [
        {
          name: "a", path: "a", is_dir: true,
          children: [
            { name: "file.ts", path: "a/file.ts", is_dir: false, children: [], file_count: 0, indexed: false, dir_index_status: "none" },
          ],
          file_count: 1, indexed: false, dir_index_status: "none",
        },
      ],
...
describe("collect_file_paths", () => {
  ...
  it("returns empty for empty directory", () => {
    const dir: FileTreeNode = {
      name: "empty", path: "empty", is_dir: true, children: [], file_count: 0, indexed: false, dir_index_status: "none",
    };
